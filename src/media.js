...
export const homeProducts = [
  {
    ...
    about:
      "Agrosmart is a pioneering farm business dedicated to vegetable production, pioneering innovative techniques to cultivate a wide range of nutrient-rich vegetables. Our farm leverages cutting-edge technology such as hydroponics and vertical farming to optimize...",
  ...
  },
  {
    ...
    about:
      "Agrosmart is a leading farm business specializing in fruit production, dedicated to cultivating an extensive variety of delicious and nutritious fruits. Situated in an idyllic countryside setting, our farm utilizes sustainable farming practices to ensure the highest...",
    url: "/our-farm/fruits",
  },
  {
    name: "Oil Production",
    ...
    about:
      "Agrosmart is a pioneering farm business that specializes in vegetable oil production, harnessing the power of nature to create high-quality oils from a variety of crops. Situated on expansive fields, our farm employs innovative techniques such as cold-pressing and...",
  ...
  },
  {
    ...
    about:
      "Agrosmart is a renowned farm business specializing in livestock production, renowned for its commitment to ethical and sustainable farming practices. Our sprawling pastures provide a nurturing environment for a variety of livestock, including grass-fed cattle...",
  ...
  },
  {
    ...
    about:
      "Agrosmart is a pioneering farm business that specializes in fish production, harnessing sustainable aquaculture practices to cultivate premium-quality seafood. Nestled in pristine waters, our farm maintains a healthy and natural environment for our fish, ensuring...",
